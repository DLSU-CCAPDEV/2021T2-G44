...
appRouter.put(
    "/register",
    UserController.validateUserData("createUser"),
...
appRouter.post(
    "/api/user",
    UserController.validateUserData("updateUser"),
    UserController.updateUser
);
appRouter.post(
    "/api/user/password",
    UserController.validateUserData("changePassword"),
    UserController.changePassword
);
appRouter.delete(
    "/api/user",
    UserController.validateUserData("deleteAccount"),
...
appRouter.post(
    ...
    MailController.validateMailData("read"),
    MailController.toggleRead
);
appRouter.put(
    "/api/mail/send/:recepientEmail",
    MailController.validateMailData("send"),
