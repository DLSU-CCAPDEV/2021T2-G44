        ...
        <div>
                            ...
                            <TableBody>
                                {eventAppointments &&
                                    eventAppointments.map((appointment, index) => {
                                        var content = `${moment(appointment.startTime).format(
                                            'MMMM Do YYYY, h:mm:ss a'
                                        )} - ${moment(appointment.endTime).format('MMMM Do YYYY, h:mm:ss a')}`;
            ...
            <Dialog open={inviteUserOpen} onClose={handleInviteUserOpen} maxWidth="sm" fullWidth={true}>
                ...
                <DialogActions>
                    ...
                    <Button
                        onClick={(e) => handleConfirmInviteUser({ vertical: 'top', horizontal: 'center' })}
                        color="primary"
                    >
                        Invite User
                    </Button>
