...
export default function Homepage() {
    ...
    return (
        <Grid container direction="column" style={{ padding: '10em 0 5em 0' }}>
            <Grid item container direction="row" justify="center" style={{ paddingBottom: '10em' }}>
                ...
                >
                    ...
                    <Fab variant="extended" size="large" color="primary" component={Link} to={'/about'}>
            ...
            {/* BOTTOM WHITE PART */}
            <Grid item container direction="row" justify="center" style={{ paddingBottom: '10em', paddingTop: '10em' }}>
